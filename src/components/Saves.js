...
const Saves = ({sendData}) => {
  ...
  useEffect(()=>{callBackMethod({str: strSave, dex:dexSave, con: conSave, int: intSave, wis: wisSave, cha: chaSave})})
        ...
        return (
          <div className="form-check" key={index}>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control bg-dark" name="" id={value + "Mod"} aria-describedby="helpId" placeholder="+0" onChange={setSave[index]}/>
